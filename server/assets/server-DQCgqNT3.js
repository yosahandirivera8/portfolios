...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BqhtJfef.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DXClO0qM.js").then((n) => n.r),
    import("./start-Bn4e9NBC.js"),
...
var ROUTER_BASEPATH = "portfolios";
var SERVER_FN_BASE = "/portfolios/_serverFn/";
